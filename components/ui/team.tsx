...
const teamMembers: ProfileMember[] = [
  ...
  },
  {
    ...
    social: [
      ...
      { label: "GitHub", url: "https://github.com/Chaessoo" },
    ],
    location: "Jakarta, Indonesia",
    education: [
      {
        school: "Vocational High School Bhinneka Karya 5",
        degree: "Communication and Network Engineering",
        years: "2019 - 2023",
      },
    ],
    ...
    languages: [
      ...
      { name: "Indonesian", level: 100 },
      { name: "Japanese", level: 80 },
    ],
    highlights: ["backend developer", "web developer", "laravel"],
  },
  {
